...
public class PlayerController : MonoBehaviour
{
    ...
    [Tooltip("The speed at which the player rotates to look left and right (calculated to degrees)")]
    ...
    private void SetUpCharacterController()
    {
        ...
        if (controller == null)
        {
            Debug.LogError("The player controller script does not hava a character controller on the same game object");
        }
    }
    ...
    void ProcessMovement()
    {
        ...
        // Handle the control of the player while its on the ground
    ...
    void ProcessRotation()
    {
        ...
        transform.rotation = Quaternion.Euler(new Vector3(playerRotation.x,playerRotation.y + horizontalLookInput * 
            lookSpeed * Time.deltaTime, playerRotation.z));
    }
